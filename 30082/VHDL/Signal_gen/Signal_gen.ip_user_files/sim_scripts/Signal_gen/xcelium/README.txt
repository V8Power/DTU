...
#
# Generated by export_simulation on Wed Jan 04 13:39:34 +0100 2023
#
################################################################################
...
'-reset_run' switch to the './sinusLUT.sh' script.

./sinusLUT.sh -reset_run
...
./sinusLUT.sh -noclean_files

For more information on the script, please type './sinusLUT.sh -help'.
